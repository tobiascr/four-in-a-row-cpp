...
/* This program takes text files with lists of transpositions as input. Each line should
   ...
   g++ -O3 -c make_time_tables.cpp
   g++ -o make_time_tables make_time_tables.o ../engine_API.o ../game_state.o ../opening_book.o ../transposition_table.o
*/
...
int main()
{
    ...
    while (std::getline(file_to_read, transposition_move_string))
    {
        ...
        move_time = t1 - t0;
        file_to_write << transposition_move_string << " " << std::to_string(best_move);
